    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('confirmation_code', models.CharField(default=api.utils.confirmation_code_generator, max_length=10, verbose_name='код подтверждения')),
                ('first_name', models.CharField(blank=True, max_length=150)),
                ('last_name', models.CharField(blank=True, max_length=150)),
                ('username', models.CharField(max_length=150, unique=True, validators=[django.core.validators.RegexValidator(message='Username must contain letters, numbers and @.+-_', regex='^[a-zA-Z0-9@.+-_]*$')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.IntegerField(validators=[api.utils.validate_date_not_in_future])),
