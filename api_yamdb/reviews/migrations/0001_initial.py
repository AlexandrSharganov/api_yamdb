# Generated by Django 2.2.16 on 2022-06-21 16:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('anonymous', 'anonymous'), ('user', 'user'), ('moderator', 'moderator'), ('admin', 'admin')], default='user', max_length=10)),
                ('bio', models.TextField(blank=True, verbose_name='Биография')),
                ('email', models.EmailField(max_length=255, unique=True, verbose_name='электронная почта')),
                ('confirmation_code', models.CharField(default='xMppGlkEzE', max_length=10, verbose_name='код подтверждения')),
