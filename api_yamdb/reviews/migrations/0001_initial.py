    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ANON', 'Anonymous'), ('USER', 'User'), ('MOD', 'Moderator'), ('ADM', 'Admin')], default='USER', max_length=4)),
                ('bio', models.TextField(blank=True, verbose_name='Биография')),
                ('email', models.EmailField(max_length=255, unique=True, verbose_name='электронная почта')),

                ('confirmation_code', models.CharField(default='KfQWeMzylr', max_length=10, verbose_name='код подтверждения')),
