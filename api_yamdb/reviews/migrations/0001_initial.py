# Generated by Django 2.2.16 on 2022-06-27 15:57
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=150, unique=True, validators=[django.core.validators.RegexValidator(message='Имя пользователя может\n                содержать буквы, цифры, и @.+-_', regex='^[a-zA-Z0-9@.+-_]*$'), api.utils.validate_model_username])),
